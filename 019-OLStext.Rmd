...
```
```{thm title='Least Squares Problem and Solution' , id='leastsquares', num=thmcounter, cid=cid}
...
```
```{ex title='Solving a Least Squares Problem', id='lsex',num=excounter, cid=cid}
...
```{r fig.align='center', fig.cap = '(ref:lsprojcap)', echo=F, fig.width=10}
