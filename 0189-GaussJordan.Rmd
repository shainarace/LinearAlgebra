...
using Gauss-Jordan Elimination.
 ...
 Since $AA^{-1} = I$, we set up the augmented matrix as $\left(\begin{array}{r|r} \boldsymbol{A} & I\end{array}\right)$:
...
$$\boldsymbol{S}= diag\{\sigma_1, \sigma_2,\dots,\sigma_p\}.$$ Give a formula for a matrix that contains the same data but with each variable divided by its standard deviation. _Hint: This problem connects Text Exercise \@ref(exr:diagmultexer) and Example \@ref(exm:diaginverse)_. 
</ol>
