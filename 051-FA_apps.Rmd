...
<!-- \begin{figure*}[h!] -->
<!-- \centering -->
<!-- \includegraphics[width=10cm]{factorOutput.png} -->
<!-- \caption{} -->
<!-- \includegraphics[width=13cm]{scoresOutput.png} -->
<!-- \caption{} -->
<!-- \end{figure*} -->
<!-- \vspace{.5cm} -->
...
(ref: rotloads) Rotated Factor Loadings Output by SAS

```{r fig.align='center', echo=F, fig.cap='(ref: rotloads)'}
knitr::include_graphics('RotatedLoadings.png')
```

(ref: rotscores) Rotated Factor Scores Output by SAS

```{r fig.align='center', fig.cap='(ref: rotscores)'}
knitr::include_graphics('RotatedScores.png')
```
<!-- \begin{figure*}[h!] -->
<!-- \centering -->
<!-- \includegraphics[width=9cm]{RotatedLoadings.png} -->
<!-- \caption{} -->
<!-- \includegraphics[width=11cm]{RotatedScores.png} -->
<!-- \caption{} -->
<!-- \end{figure*} -->
